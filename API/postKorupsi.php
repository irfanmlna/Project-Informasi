...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (
        ...
        isset($_POST['no_hp']) &&
        isset($_POST['no_ktp']) &&
        isset($_POST['uraian_singkat']) &&
        isset($_POST['laporan_pengaduan'])
    ) {
        $nama_pelapor = $_POST['nama_pelapor']; // Update to use 'nama_pelapor'
        $no_hp = $_POST['no_hp'];
        $no_ktp = $_POST['no_ktp'];
        ...
        $sql = "INSERT INTO tb_korupsi (nama_pelapor, no_hp, no_ktp, uraian_singkat, laporan_pengaduan, file_ktp, file_laporan) 
                VALUES ('$nama_pelapor', '$no_hp', '$no_ktp', '$uraian_singkat', '$laporan_pengaduan', '$file_ktp', '$file_laporan')";
