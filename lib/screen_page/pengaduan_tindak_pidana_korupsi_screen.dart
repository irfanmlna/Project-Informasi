...
class PengaduanTindakPidanaKorupsi extends StatefulWidget {
  @override
  _PengaduanTindakPidanaKorupsiState createState() =>
      _PengaduanTindakPidanaKorupsiState();
}

class _PengaduanTindakPidanaKorupsiState
    extends State<PengaduanTindakPidanaKorupsi> {
  TextEditingController _namaPelaporController =
      TextEditingController(); // Change namaController to namaPelaporController
  TextEditingController _noHpController = TextEditingController();
  TextEditingController _noKtpController = TextEditingController();
  TextEditingController _uraianSingkatController = TextEditingController();
  ...
  Future<void> _submitForm() async {
    final uri =
        Uri.parse('$ip/postKorupsi.php');
    final request = http.MultipartRequest('POST', uri);

    request.fields['nama_pelapor'] =
        _namaPelaporController.text; // Change 'nama' to 'nama_pelapor'
    request.fields['no_hp'] = _noHpController.text;
    request.fields['no_ktp'] = _noKtpController.text;
    request.fields['uraian_singkat'] = _uraianSingkatController.text;
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              ...
              TextField(
                controller:
                    _namaPelaporController, // Change to _namaPelaporController
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'Masukkan Uraian Singkat',
                  border: OutlineInputBorder(),
                ),
              ),
              SizedBox(height: 20.0),
